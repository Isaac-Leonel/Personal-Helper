...
class SalvarIdosoForm extends StatelessWidget {
  const SalvarIdosoForm({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    Future<String> postIdoso() async {
      ...
      final response =
          await http.post(Uri.parse('${idosoAPI}/api/ph/elderly/save'),
              ...
              body: jsonEncode(<String, String>{
                ...
                "emergencycontact": contController.text
              }));
