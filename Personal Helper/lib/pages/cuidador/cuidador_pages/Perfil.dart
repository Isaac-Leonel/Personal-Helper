...
class PerfilCui extends StatefulWidget {
  const PerfilCui({Key? key}) : super(key: key);

  @override
  State<PerfilCui> createState() => _PerfilCui();
}

class _PerfilCui extends State<PerfilCui> {
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(
                            MaterialPageRoute(builder: (_) => SelectIdoso()));
                      },
                    ),
                  ),
                  const Padding(
