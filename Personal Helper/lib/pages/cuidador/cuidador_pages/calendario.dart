...
class CalendarioCui extends StatefulWidget {
  const CalendarioCui({Key? key}) : super(key: key);

  @override
  State<CalendarioCui> createState() => _CalendarioCui();
}

class _CalendarioCui extends State<CalendarioCui> {
            ...
            children: [
              Padding(
                  ...
                  child: const ProfileBarCuida(
                      exibirSaud: false, exibirBack: true)),
            ],
          ),
          Padding(
