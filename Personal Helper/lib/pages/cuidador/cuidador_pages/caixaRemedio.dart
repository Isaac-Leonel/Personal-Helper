...
class caixaRemedioCui extends StatefulWidget {
  const caixaRemedioCui({Key? key}) : super(key: key);

  @override
  State<caixaRemedioCui> createState() => _caixaRemedioCui();
}

class _caixaRemedioCui extends State<caixaRemedioCui> {
